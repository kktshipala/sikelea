...
class LecturerListView(ListView):
    ...
    paginate_by = 1000000  # if pagination is desired

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Lecturers | ESYSTEM "
        return context
...
def student_add_view(request):
    ...
    return render(
        ...
        {"title": "Add Student | ESYSTEM ", "form": form},
    )
...
class StudentListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = "Students | ESYSTEM "
        return context
