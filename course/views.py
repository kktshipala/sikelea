...
def program_edit(request, pk):
    ...
    return render(
        request,
        "course/program_add.html",
        {"title": "Edit Program | ESYSTEM ", "form": form},
    )
...
class CourseAllocationFormView(CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["title"] = "Assign Course | ESYSTEM "
        return context
...
def course_allocation_view(request):
    ...
    return render(
        ...
        {
            "title": "Course Allocations | ESYSTEM ",
...
def edit_allocated_course(request, pk):
    ...
    return render(
        ...
        {"title": "Edit Course Allocated | ESYSTEM ", "form": form, "allocated": pk},
    )
...
def handle_file_upload(request, slug):
    ...
    return render(
        ...
        {"title": "File Upload | ESYSTEM ", "form": form, "course": course},
    )
...
def handle_video_upload(request, slug):
    ...
    return render(
        ...
        {"title": "Video Upload | ESYSTEM ", "form": form, "course": course},
    )
