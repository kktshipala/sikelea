...
STATIC_URL = "SIKELEA/static/"
MEDIA_URL = "SIKELEA/media/"
STATICFILES_DIRS = [
...
MEDIA_ROOT = os.path.join(BASE_DIR, "SIKELEA/static/media")

STATIC_ROOT = os.path.join(BASE_DIR, "SIKELEA/staticfiles")
